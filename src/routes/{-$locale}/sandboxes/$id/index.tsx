...
export const Route = createFileRoute("/{-$locale}/sandboxes/$id/")({
  component: () => {
...
function EntityMap({ hub }: { hub: SandboxHubData }) {
  ...
  const entities = [
    ...
    },
    {
      ...
      icon: EpicTrophyIcon,
      to: "/{-$locale}/sandboxes/$id/achievements",
    },
    {
