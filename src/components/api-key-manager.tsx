      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            <Input
              ...
              type="text"
              placeholder={
                apiKey ? 'API key generated' : 'No API key generated'
              }
              value={apiKey}
              readOnly
              className={cn(
        ...
        {apiKey && (
          <div className="text-sm text-muted-foreground">
            Your API key is a UUID stored locally in your browser and is used to
            authenticate push notification requests. Use the regenerate button
